...
class MainFragment : Fragment() {
    ...
    private fun initLensEngine() {
        ...
        val creator = generateSkeletonDetectionLensEngineCreator()
        lensEngine = creator
    ...
    private fun generateSkeletonDetectionLensEngineCreator() : LensEngine.Creator {
        analyzer = MLSkeletonAnalyzerFactory.getInstance().skeletonAnalyzer.apply {
            setTransactor(object : MLAnalyzer.MLTransactor<MLSkeleton> {
