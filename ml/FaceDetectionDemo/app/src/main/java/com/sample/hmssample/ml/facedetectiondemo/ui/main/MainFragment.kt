...
import com.sample.hmssample.ml.facedetectiondemo.R
import com.sample.hmssample.ml.facedetectiondemo.databinding.MainFragmentBinding
...
class MainFragment : Fragment() {
    ...
    private fun initLensEngine() {
        ...
        val creator = generateFaceDetectionLensEngineCreator()
        lensEngine = creator
    ...
    private fun generateFaceDetectionLensEngineCreator() : LensEngine.Creator {
        ...
        return LensEngine.Creator(context, faceAnalyzer)
    }
