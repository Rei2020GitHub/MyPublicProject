...
import com.sample.hmssample.ml.handkeypointdetectiondemo.R
import com.sample.hmssample.ml.handkeypointdetectiondemo.databinding.MainFragmentBinding
...
class MainFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        viewModel.lensType.observe(viewLifecycleOwner, Observer {
            refreshLensEngine()
        })
        ...
        binding.buttonCamera.setOnClickListener {
            viewModel.lensType.postValue(if (viewModel.lensType.value == LensEngine.FRONT_LENS) LensEngine.BACK_LENS else LensEngine.FRONT_LENS)
        }
    ...
    private fun initLensEngine() {
        ...
        val creator = generateHandKeypointDetectionLensEngineCreator()
        lensEngine = creator
