...
enum KeyCode {
    ...
    KEY_CODE_F11,
    KEY_CODE_F12,
    KEY_CODE_KP_0, // 数字键盘 0
    KEY_CODE_KP_1, // 数字键盘 1
    KEY_CODE_KP_2, // 数字键盘 2
    KEY_CODE_KP_3, // 数字键盘 3
    KEY_CODE_KP_4, // 数字键盘 4
    KEY_CODE_KP_5, // 数字键盘 5
    KEY_CODE_KP_6, // 数字键盘 6
    KEY_CODE_KP_7, // 数字键盘 7
    KEY_CODE_KP_8, // 数字键盘 8
    KEY_CODE_KP_9, // 数字键盘 9
    ...
    KEY_CODE_LEFT_SHIFT, // 左 shift
    KEY_CODE_LEFT_CONTROL, // 左 ctrl
