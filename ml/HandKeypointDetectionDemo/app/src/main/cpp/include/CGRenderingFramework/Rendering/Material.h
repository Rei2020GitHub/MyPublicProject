...
public:
    ...
    void SetSamplerParam(TextureType type, SamplerFilter filterMin, SamplerFilter filterMag,
        SamplerMipmapMode filterMipmap, SamplerAddress addressMode);
